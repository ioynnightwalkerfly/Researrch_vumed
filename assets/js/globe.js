...
// เพิ่มการเช็ค: ถ้าหน้านั้นไม่มี Globe ก็ไม่ต้องรัน JS ต่อ (กัน Error)
if (!container) {
    throw new Error("Globe container not found on this page.");
}
...
function getData() {
    ...
    request.open('GET', 'assets/data/globe-points.json', true);
