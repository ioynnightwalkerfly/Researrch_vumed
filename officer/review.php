...
<head>
    ...
    <title>ตรวจแบบเสนอโครงการ - Officer Review</title>
...
<body class="bg-gray-50 min-h-screen pb-12">
    ...
    <header class="bg-white shadow-sm border-b sticky top-0 z-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            <div class="flex items-center gap-4">
                <a href="dashboard.php" class="text-gray-500 hover:text-blue-600 transition"><i class="fa-solid fa-arrow-left"></i> กลับ</a>
                <div class="h-6 w-px bg-gray-300"></div>
                <h1 class="font-bold text-gray-800 text-lg">ตรวจสอบข้อเสนอโครงการ</h1>
            </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    <div class="bg-blue-50 px-6 py-4 border-b border-blue-100 flex justify-between items-center">
                        <h2 class="font-bold text-blue-800"><i class="fa-solid fa-file-invoice mr-2"></i> ข้อมูลทั่วไป</h2>
                        ...
                        <table class="w-full text-left text-sm">
                            <thead class="bg-gray-50 text-gray-500 font-semibold border-b">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-right">ไฟล์</th>
                                    <th class="px-6 py-3 text-center w-32">ตรวจสอบ</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-gray-100">
                                <?php foreach ($documents as $doc): ?>
                                    <tr class="group hover:bg-gray-50 transition">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="font-medium text-gray-800"><?php echo htmlspecialchars($doc['doc_name'] ?? 'Document'); ?></div>
                                        </td>
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-xl shadow-lg border border-gray-200 sticky top-24">
                    <div class="p-6 border-b border-gray-100">
                        <h2 class="font-bold text-gray-800 text-lg">ผลการพิจารณา</h2>
                    </div>
                    ...
                    <div class="p-6 space-y-6">
                        <div class="space-y-3">
                            <label class="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-green-50 transition" onclick="toggleReason(false)">
                                ...
                                <div class="ml-3">
                                    ...
                                    <span class="block text-xs text-gray-500">ส่งต่อให้เลขาฯ</span>
                                </div>
                            </label>
                            ...
                            <label class="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-orange-50 transition" onclick="toggleReason(true)">
                                ...
                                <div class="ml-3">
                                    ...
                                    <span class="block text-xs text-gray-500">แจ้งสิ่งที่ต้องแก้ไข</span>
                                </div>
                            </label>
                        </div>
                        ...
                        <div id="return-reason-area" class="hidden space-y-3">
                            ...
                            <textarea id="reason-text" rows="4" class="w-full p-3 border rounded-lg text-sm" placeholder="ระบุรายละเอียด..."></textarea>
                        </div>
    ...
    <script>
        ...
        async function submitReview() {
            ...
            formData.append('action', 'officer_review');
            ...
            try {
                const res = await fetch('../api/officer_action.php', { method: 'POST', body: formData });
